...
//   const [searchQuery, setSearchQuery] = useState("");
//   const [isLoggedIn, setIsLoggedIn] = useState(false); // New state for checking login status
...
//               <button className="btn btn-secondary dropdown-toggle ms-3" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            ...
            <form onSubmit={handleSearch} className="d-flex position-relative">
              ...
              {suggestions.length > 0 && (
                <ul className="list-group position-absolute" style={{ zIndex: 1000, top: "100%" }}>
